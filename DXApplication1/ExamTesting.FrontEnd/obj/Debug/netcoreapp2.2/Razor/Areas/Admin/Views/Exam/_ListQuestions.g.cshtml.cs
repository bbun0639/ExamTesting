#pragma checksum "D:\TraineePROJ\Proj 5 ExamTesting\ExamTesting\DXApplication1\ExamTesting.FrontEnd\Areas\Admin\Views\Exam\_ListQuestions.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "dbaf7bf81ba0d1b63618f5a1ddc839bf85cc740d"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"dbaf7bf81ba0d1b63618f5a1ddc839bf85cc740d", @"/Areas/Admin/Views/Exam/_ListQuestions.cshtml")]
...
Write(Html.DevExtreme().DataGrid<ExamTesting.Models.QuestionExam>()
    ...
    .Columns(columns =>
    {
        columns.AddFor(m => m.QuestionId).Caption("Questions").Width(400)
    ...
    WriteLiteral("\r\n                    <a href=\"/Admin/Question/Index/<%= data.Question.QuestionId %>\"><%= data.Question.QuestionStr %></a>\r\n            ");
    EndContext();
    PopWriter();
}
)
        ...
        columns.AddFor(m => m.Question.TopicId).Visible(true).Caption("Topic")
        .Lookup(lookup => lookup
